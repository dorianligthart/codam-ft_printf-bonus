...
BON_NAMES1 = ft_printf_bonus.c ft_pf_structs_bonus.c ft_pf_set_va_arg_bonus.c
BON_NAMES2 = ft_acquire_length_bonus.c ft_double_len_bonus.c ft_intmax_size_t_ptrdiff_len_bonus.c ft_signed_len_bonus.c ft_unsigned_len_bonus.c
BON_NAMES3 = ft_paste_and_print_list_bonus.c ft_paste_double_bonus.c ft_paste_intmax_size_t_ptrdiff_bonus.c ft_paste_signed_bonus.c ft_paste_unsigned_bonus.c

SRC_SRC    = $(addprefix src/libft/, $(SRC_NAMES))
MAN_SRC    = $(addprefix src/man/, $(MAN_NAMES))
BON_SRC1   = $(addprefix src/bon/, $(BON_NAMES1))
BON_SRC2   = $(addprefix src/bon/len/, $(BON_NAMES2))
BON_SRC3   = $(addprefix src/bon/paste/, $(BON_NAMES3))
